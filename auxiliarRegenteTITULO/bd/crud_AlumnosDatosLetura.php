...
datosalumnos.nombreTutor, datosalumnos.dniTutor, datosalumnos.TelefonoTutor, datosalumnos.idPlanEstudio, plan_datos.nombre FROM datosalumnos INNER JOIN plan_datos ON datosalumnos.idPlanEstudio= plan_datos.idPlan WHERE datosalumnos.idAlumnos='$idAlumnos'";       
