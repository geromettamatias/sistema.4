...
<!-- Divider -->
      ...
      <!-- Nav Item - Pages Collapse Menu -->
        ...
        <div id="collapseTwoCarga2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Situación</h6>
           
             <a class="collapse-item" id="libretaDigital"><i class="fas fa-stroopwafel fa-spin"></i> Gestión-Academica</a>
        
            <a class="collapse-item" id="analiticos"><i class="fas fa-stroopwafel fa-spin"></i> Analítico</a>
