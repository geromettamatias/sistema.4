      ...
      <!-- Nav Item - Pages Collapse Menu -->
        ...
        <div id="collapseTwoCarga2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" id="analiticoAlumno"><i class="fas fa-stroopwafel fa-spin"></i> Analítico</a>
            <a class="collapse-item" id="libretaDigitalAlumno"><i class="fas fa-stroopwafel fa-spin"></i> Libreta Digital</a>
             <a class="collapse-item" id="inasistencia"><i class="fas fa-stroopwafel fa-spin"></i> Inasistencia</a>
             <a class="collapse-item" id="inscrpMesasExamen"><i class="fas fa-stroopwafel fa-spin"></i> Inscrp Mesas</a>
             <a class="collapse-item" id="visualizarNotaMesa"><i class="fas fa-stroopwafel fa-spin"></i> Visualizar MESA</a>
      ...
      <div class="sidebar-heading">
        ...
        <div id="collapseTwoCarga23" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" id="mensajeDocente"><i class="fas fa-stroopwafel fa-spin"></i> Docente</a>
