...
<input hidden="" id="ciclo" value="<?php echo $cicloLectivo; ?>">
        ...
        <div class="col-lg-12 p-2">
             <button type="submit"  type="button" class="btn btn-outline-primary btn-block modalCRUD_Libreta_Docentefi" disabled="true">Libreta  <span class="badge badge-light"> GUARDAR LOS DATOS EDITADOS Y ACTUALIZAR ANALÍTICO</span></button>
