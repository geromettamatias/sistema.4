                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                $id_usuario=$dat['id_usuario'];
                                 ...
                                 $consulta = "SELECT `idDocente`, `dni`, `nombre` FROM `datos_docentes` WHERE `idDocente`='$id_usuario'";
                                    $resultado = $conexion->prepare($consulta);
                                    $resultado->execute();
...
function  eliminarmensajeAdminFina(id_mensaje,opcion){
    ...
    if(respuesta){
        ...
        $.ajax({
            url: "bd/crud_datos_mensajeAdminProfesor.php",
            type: "POST",
            dataType: "json",
            ...
            datos = data[0].datos;
                      ...
                      $.ajax({
                        ...
                        success: function(data){  
                            ...
                            if(opcion == 1){tablaAlumnoMensaje.row.add([id_mensaje,nombre+dni,fecha,mensaje,datos]).draw();}
                            else{tablaAlumnoMensaje.row(fila).data([id_mensaje,nombre+'--'+dni,fecha,mensaje,datos]).draw();} 
