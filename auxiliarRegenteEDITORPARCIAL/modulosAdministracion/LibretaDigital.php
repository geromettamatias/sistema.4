...
<input hidden="" id="ciclo" value="<?php echo $cicloLectivo; ?>">
        ...
        <div class="col-lg-12 p-2">
             <button type="submit"  type="button" class="btn btn-outline-primary btn-block modalCRUD_Libreta_Docentefi" >Libreta  <span class="badge badge-light">ACTUALIZAR ANALÍTICO CON LOS DATOS</span></button>
            <button type="button" class="btn btn-outline-danger btn-block modalCRUD_Libreta_DocentefiFinal">Libreta Digital <span class="badge badge-light"> Imprimir Toda la Libreta</span></button>
            <button type="button" class="btn btn-outline-success btn-block modalCRUD_Libreta_DocentefiFinalFichaAlumno">Ficha Digital <span class="badge badge-light"> Imprimir Toda la Ficha</span></button>
        </div>
                    ...
                    <div class="table-responsive">        
                        ...
                        <thead class="text-center">
                            <tr>
                                ...
                                ?>
                                <th><span style='  font-size: 12px;writing-mode: vertical-rl; transform: rotate(180deg); vertical-align:middle;'>
                                ...
                                <button class="btn btn-danger glyphicon glyphicon-pencil" onclick="imprimirFila('<?php echo $nom ?>')" title="Imprimir Columna de la Libreta"><i class="fas fa-cog fa-spin"></i></button>

                                <button class="btn btn-success glyphicon glyphicon-pencil" onclick="imprimirFilaF('<?php echo $nom ?>')" title="Imprimir Columna Ficha"><i class="fas fa-cog fa-spin"></i></button>
...
//botón EDITAR    
$(document).on("click", ".modalCRUD_Libreta_DocentefiFinal", function(e){

e.preventDefault(); 
 
   window.open('modulosAdministracion/LibretaDigitalExtra.php', '_blank'); 

    

});
$(document).on("click", ".modalCRUD_Libreta_DocentefiFinalFichaAlumno", function(e){

e.preventDefault(); 
 
   window.open('modulosAdministracion/LibretaDigitalExtraFichaAlumno.php', '_blank'); 
...
Swal.fire({
  title: 'ESTA SEGURO ACTUALIZAR EL ANALITICO',
...
function imprimirFilaF(numeroFila) {
     ...
     $.ajax({
          ...
          url:'modulosAdministracion/elementos/imprimirColumnaNotaLibreta.php',
          success:function(r){
          
             window.open('modulosAdministracion/LibretaDigitalExtraColumnaFinalFicha.php', '_blank'); 
...
function imprimirFila(numeroFila) {
     ...
     $.ajax({
          ...
          success:function(r){
             ...
             window.open('modulosAdministracion/LibretaDigitalExtraColumnaFinal.php', '_blank'); 
