...
<div id="ocultarBotonImpri" class="container ">
  <div class="row ">
    <div class="col-lg-12 p-4 ">
      <button class="boton_personalizado  print">Imprimir la/s Volates</button>
    </div>
  </div>
</div>
...
<h2 style="text-align: center;"><span style="text-align: center;"><img style="width:50px;"  src="../../escudoProvincia.png"></h2>
