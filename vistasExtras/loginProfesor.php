          ...
          <h3 class="font-weight-bold mb-2">Profesor</h3>
                <form id="formProfesor" class="mb-2">
                    <div class="mb-2">
                      ...
                      <div class="mb-2">
                        ...
                        <label for="passwordDocente" class="form-label font-weight-bold">Contraseña</label>
                            <input type="password" class="form-control bg-dark-x border-0 mb-2" id="passwordDocente" placeholder="Ingresa tu contraseña">
