      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Gerometta Mathias <img src="../1.gif" style="width: 40px;"></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
...
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
  ...
  <script src="js/sb-admin-2.min.js"></script>
   ...
   <script type="text/javascript" src="vendor/datatables/datatables.min.js"></script> 
    ...
    <script src="vendor/datatables/pdfmake.js"></script>    
 ...
 <script src="https://cdn.datatables.net/fixedcolumns/3.3.2/js/dataTables.fixedColumns.min.js"></script> 
    ...
    <script type="text/javascript" src="js_Funciones/funcion_Inscripcion.js"></script>
    <script type="text/javascript" src="js_Funciones/funcion_libretaDigital.js"></script>   
  
    <script type="text/javascript" src="js_Funciones/funcion_AnaliticoFina.js"></script> 
