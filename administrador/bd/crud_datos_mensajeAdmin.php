...
switch($opcion){
    case 1: //alta
        $consulta = "INSERT INTO `mensajes`(`id_mensaje`, `datos`) VALUES ('$id_mensaje','$datos')";			
        ...
        break;
    case 2: //modificación
        $consulta = "UPDATE `mensajes` SET `id_mensaje`='$id_mensaje',`datos`='$datos' WHERE `id_mensaje`='$id_mensaje'";		
        $resultado = $conexion->prepare($consulta);
        $resultado->execute();        
