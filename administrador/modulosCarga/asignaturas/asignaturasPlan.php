<?php
        ...
        if ($planSele!=1){
            $consulta = "SELECT `idAsig`, `idPlan`, `nombre`, `ciclo` FROM `plan_datos_asignaturas` WHERE `idPlan`='$planSele'";
...
<div class="container">
    <div class="row">
        <div class="col-lg-12 p-2">
                     <h1>Tabla de Asignatura del Plan de Estudio</h1>
                     <p><b>Aclaración:</b>Las asignatura del correspondiente a 3ro, 4to y 5to (y más) corresponden al Planes de estudios seleccionado...</p>
                </div>
        <div class="col-lg-12 p-2">
    ...
    <div class="modal-dialog" role="document">
        ...
        <form id="formPersonasPlanAsignatura">    
            ...
            <div class="modal-body">
                <input type="text"  id="idPlanAsignatura" hidden="">

                <div class="form-group">
                <label for="cicloff" class="col-form-label">Corresponde al:</label>
                <select class="form-control" id="cicloff">
...
$("#btnNuevo_Asignatura").click(function(){
    ...
    idPlanAsignatura= $('#planSele').val();

    $("#idPlanAsignatura").val(idPlanAsignatura);
...
$("#formPersonasPlanAsignatura").submit(function(e){
    ...
    idPlan = $.trim($("#idPlanAsignatura").val());
    nombre = $.trim($("#asigantura").val());
    ciclo = $.trim($("#cicloff").val());
