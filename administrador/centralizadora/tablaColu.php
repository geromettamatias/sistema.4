...
<button type="button" class="btn btn-outline-success btn-block modalCRUD_Centralizadora">Imprimir la Centralizadora </button>
...
e.preventDefault(); 
   ...
   window.open('centralizadora/tablaColuImprimir.php', '_blank'); 
